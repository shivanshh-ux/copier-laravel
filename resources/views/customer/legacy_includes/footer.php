    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-10 sm:mb-12">
            ...
            <div class="sm:col-span-2 lg:col-span-1">
                <a href="index.php" class="inline-flex items-center gap-3 mb-4 sm:mb-5" style="text-decoration:none;">
            ...
            <div>
                ...
                <ul class="space-y-2 sm:space-y-3">
                    <li><a href="index.php"    class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">Home</a></li>
                    <li><a href="about.php"    class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">About Us</a></li>
                    <li><a href="services.php" class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">Services</a></li>
                    <li><a href="help.php"     class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">Help Center</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 sm:space-y-3">
                    <li><a href="login.php"   class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">Login</a></li>
                    <li><a href="signup.php"  class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">Create Account</a></li>
                    <li><a href="profile.php" class="text-sm opacity-60 hover:opacity-100 transition-opacity duration-300" style="color: #E2E8F0; text-decoration:none;">Your Profile</a></li>
                </ul>
            </div>
